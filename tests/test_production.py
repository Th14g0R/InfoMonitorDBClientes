...
class ProductionConfigTests(unittest.TestCase):
    ...
    def test_instaladores_usam_runner_lock_e_diretorio_absoluto(self):
        ...
        self.assertIn('[2] Atualizar arquivos', windows)
        ...
        self.assertIn('SUCESSO: arquivos atualizados em $Target', windows)
        self.assertIn('function Activate-PendingUpdate', windows)
